...
# Configure PyMySQL to be used as MySQLdb replacement
import pymysql
...
SECRET_KEY = 'django-insecure-y9t^q&%k(a%0v@6var(9z6$$0@3#dsm0jrzac&!bo0u28id575'
...
# Media (for generated log sheet PDFs)
MEDIA_URL = '/media/'
